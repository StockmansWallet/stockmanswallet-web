...
export const PRICING_TIERS: PricingTier[] = [
  // Producer Plans
  {
    ...
    price: 89,
    priceAnnual: null,
    description: "For producers managing a single property.",
    highlighted: false,
    category: "producer",
    features: [
  ...
  },
  {
    ...
    price: 159,
    priceAnnual: null,
    description: "For producers managing livestock across multiple properties as a portfolio.",
    highlighted: false,
    category: "producer",
    features: [
      { name: "Multiple properties", included: true },
      { name: "Unlimited herds", included: true },
      { name: "Live market pricing", included: true },
      { name: "Yard Book with reminders", included: true },
  ...
  // Advisor Plans
  {
    ...
    features: [
      ...
      { name: "Insights", included: true },
      { name: "Freight IQ (10 calculations/month)", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Freight IQ (25 calculations/month)", included: true },
