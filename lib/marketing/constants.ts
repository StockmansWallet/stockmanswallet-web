...
export const PRICING_TIERS: PricingTier[] = [
  // Producer Plans
  {
    ...
    price: 89,
    priceAnnual: null,
    description: "For one property getting started with live herd valuation.",
    highlighted: false,
    category: "producer",
    features: [
      ...
      { name: "Yardbook with reminders", included: true },
  ...
  },
  {
    ...
    price: 159,
    priceAnnual: null,
    description: "For growing operations managing up to three properties.",
    highlighted: false,
    category: "producer",
    features: [
  ...
  },
  {
    ...
    price: 249,
    priceAnnual: null,
    description: "For larger operations managing four or more properties.",
    highlighted: false,
    category: "producer",
    features: [
