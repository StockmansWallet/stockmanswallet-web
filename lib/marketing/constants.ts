...
export const PRICING_TIERS: PricingTier[] = [
  // Producer Plans
  {
    ...
    priceLabel: 'TBA',
    priceAnnual: null,
    description: 'For smaller herd owners wanting simple access to core livestock insights.',
    highlighted: false,
    category: 'producer',
    features: [
      ...
      { name: 'Limited Brangus AI queries', included: true },
      { name: 'Limited Freight IQ calculations', included: true },
      { name: 'Insights', included: false },
      { name: 'Grid IQ', included: false },
      { name: 'Producer Network', included: false },
      { name: 'Advisory Hub', included: false },
    ],
  },
  {
    id: 'stockman',
    ...
    features: [
      ...
      { name: 'Grid IQ', included: true },
      { name: 'Insights', included: true },
      { name: 'Producer Network', included: true },
      { name: 'Freight IQ (5 calculations/month)', included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'Market Monitor', included: true },
      { name: 'Yard Book with reminders', included: true },
      { name: 'Core reports + Market Comparison report', included: true },
      { name: 'Grid IQ + processor analysis', included: true },
      { name: 'Insights', included: true },
      { name: 'Producer Network', included: true },
      { name: 'Advisory Hub', included: true },
  ...
  // Advisor Plans
  {
    ...
    priceLabel: 'TBA',
    priceAnnual: null,
    description: 'For independent agri bankers, livestock agents, accountants, and insurers managing a smaller client book.',
    highlighted: false,
    category: 'advisor',
    features: [
