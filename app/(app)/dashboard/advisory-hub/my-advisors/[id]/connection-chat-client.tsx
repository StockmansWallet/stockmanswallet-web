...
import { sendMessage, fetchConnectionMessages } from "./actions";
...
export function ConnectionChatClient({
  connectionId,
  currentUserId,
  messages: initialMessages,
  participants,
}: ConnectionChatClientProps) {
  ...
  useEffect(() => {
    const interval = setInterval(async () => {
      const result = await fetchConnectionMessages(connectionId);
