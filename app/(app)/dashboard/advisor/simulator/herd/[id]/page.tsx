          ...
          {herd.is_breeder && (
            <Card>
              ...
              <CardContent className="px-5 pb-5 divide-y divide-white/[0.04]">
                ...
                {herd.joined_date && (herd.breeding_program_type === "ai" || herd.breeding_program_type === "controlled") && <InfoRow label="Effective Joining Date" value={new Date(herd.joined_date).toLocaleDateString("en-AU", { day: "numeric", month: "short", year: "numeric" })} />}
