...
import { signIn, signInAsDemo, signInWithApple } from "@/app/(auth)/actions";
...
export function SignInModal({ open, onClose }: SignInModalProps) {
  return (
    <Modal
      ...
      onClose={onClose}
      size="xl"
      ariaLabel="Sign in to Stockman's Wallet"
    ...
    queryErrorCode === "demo-failed"
      ...
      : queryErrorCode === "demo-not-configured"
        ...
        : queryErrorCode === "google-failed"
          ? "Couldn't sign in with Google. Please try another option."
          : queryErrorCode;
