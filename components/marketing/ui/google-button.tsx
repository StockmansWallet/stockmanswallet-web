...
export default function GoogleButton({ label = "Continue with Google" }: GoogleButtonProps) {
  return (
    <form action={signInWithGoogle}>
      <button
        type="submit"
        className="flex h-10 w-full items-center justify-center gap-2.5 rounded-full bg-white px-4 text-sm font-medium text-[#1f1f1f] transition-colors hover:bg-white/95 active:scale-[0.99]"
      >
