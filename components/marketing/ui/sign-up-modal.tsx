...
import { signUp, resendConfirmation, signInWithApple } from "@/app/(auth)/actions";
...
export function SignUpModal({ open, onClose }: SignUpModalProps) {
  return (
    <Modal
      ...
      onClose={onClose}
      size="xl"
      ariaLabel="Create your Stockman's Wallet account"
...
function SignUpPanel({ onClose }: { onClose: () => void }) {
  ...
  const queryError =
    queryErrorCode === "google-failed"
      ? "Couldn't sign up with Google. Please try another option."
      : queryErrorCode;
  ...
  if (confirmationEmail) {
    return (
      <div className="max-h-[84vh] overflow-y-auto px-5 py-7 sm:px-7 sm:py-9 lg:px-12 lg:py-12">
        <div className="flex w-full flex-col items-center gap-y-6 text-center sm:gap-y-7 lg:flex-row lg:items-stretch lg:justify-center lg:gap-x-16 lg:gap-y-0 lg:text-left">
          <div className="flex w-full max-w-[34rem] flex-col items-center gap-y-6 sm:gap-y-7 lg:max-w-[26rem] lg:flex-1 lg:items-center lg:justify-center lg:text-center">
            <div className="mx-auto w-full max-w-[12rem] sm:max-w-[14rem]">
            ...
            <div className="px-2 lg:max-w-[22rem] lg:px-0">
              <h1 className="text-[clamp(1.65rem,5vw,2.25rem)] font-semibold tracking-tight text-white lg:text-[2.1rem] lg:leading-[1.12]">
            ...
            <div className="space-y-2.5">
              <form ref={formRef} onSubmit={handleSubmit} noValidate>
                ...
                <button
                  ...
                  disabled={loading}
                  className="bg-brand hover:bg-brand-light flex h-10 w-full items-center justify-center gap-2.5 rounded-full px-4 text-sm font-semibold text-white shadow-[0_6px_20px_rgba(231,136,34,0.28)] transition-colors active:scale-[0.99] disabled:opacity-60"
                >
