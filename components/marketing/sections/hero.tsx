      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8 lg:py-32">
        ...
        <FadeInOnScroll direction="left" delay={0.3} className="flex items-center justify-center">
          <div className="relative">
            ...
            <div className="absolute -left-36 top-8 hidden w-56 rounded-[20px] bg-bg-card-1/90 p-5 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl lg:block">
            ...
            {/* Floating Chart Card */}
            <div className="absolute -right-32 bottom-24 hidden w-60 rounded-[20px] bg-bg-card-1/90 p-5 shadow-[0_8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl lg:block">
