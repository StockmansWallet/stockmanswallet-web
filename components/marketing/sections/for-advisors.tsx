    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-[1fr_auto]">
        <div className="rounded-xl bg-white/[0.04] px-4 py-3">
          ...
          <p className="text-text-muted mt-0.5 text-[10px]">Your advisor workspace overview.</p>
        </div>
        <div className="rounded-xl bg-white/[0.04] px-4 py-3 text-center sm:min-w-[200px]">
          ...
          <p className="mt-1 text-2xl font-bold text-white tabular-nums">$213,955,020</p>
          <span className="text-success mt-0.5 inline-flex items-center gap-1 text-xs font-medium">
            <svg
              className="h-3 w-3"
              viewBox="0 0 24 24"
              fill="none"
      ...
      <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
        {[
          ...
          <div key={stat.label} className="rounded-xl bg-white/[0.04] p-3">
            ...
            <p className="text-text-muted mt-0.5 text-[10px]">{stat.label}</p>
          </div>
        ))}
      </div>
                ...
                <div key={client.name} className="flex items-center gap-2.5 px-3 py-2.5">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-text-muted text-[9px]">
                      {client.property} · {client.herds} herds
                    </p>
                  </div>
                  <span
                    className={`rounded-full px-1.5 py-0.5 text-[9px] font-medium ${style.bg} ${style.text}`}
                  >
                    {style.label}
                  </span>
                </div>
        ...
        <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-4 p-3">
              ...
              <div className="relative shrink-0">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <p className="text-sm font-bold text-white tabular-nums">141</p>
                  <p className="text-text-muted text-[8px]">clients</p>
                </div>
              </div>
              ...
              <div className="min-w-0 flex-1 space-y-1.5">
                {regions.map((region) => (
                  <div key={region.name} className="flex items-center gap-2">
                    ...
                    />
                    <div className="min-w-0 flex-1">
                      <p className="text-text-secondary truncate text-[10px]">{region.name}</p>
                      <p className="text-text-muted text-[9px] tabular-nums">
                        {region.count} clients · {region.value}
                      </p>
                    </div>
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {[
              ...
              <div
                key={action.label}
                className="flex items-center gap-2 rounded-xl bg-white/[0.04] px-3 py-2.5"
              >
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#2F8CD9]/15">
                  <svg
                    className="h-3.5 w-3.5 text-[#2F8CD9]"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth={2}
                ...
                <span className="text-text-secondary text-[11px] font-medium">{action.label}</span>
              </div>
            ))}
          </div>
        </div>
    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl bg-white/[0.04] px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="bg-success/15 flex items-center gap-1.5 rounded-full px-2 py-0.5">
            <span className="bg-success h-1.5 w-1.5 rounded-full" />
            <span className="text-success text-[10px] font-medium">Active</span>
          </div>
        </div>
        <div className="mt-2 flex items-center gap-3 border-t border-white/[0.06] pt-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-text-muted text-[10px]">
              Doongara Station, QLD · 4 herds · 186 head
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
        {[
          ...
          <div key={card.label} className="rounded-xl bg-white/[0.04] p-3 text-center">
            ...
            <p className="text-text-muted mt-0.5 text-[10px]">{card.sub}</p>
          </div>
        ))}
      </div>
      ...
      <div className="rounded-xl bg-white/[0.04] p-4">
        <p className="text-text-muted mb-3 text-[10px] font-semibold tracking-wider uppercase">
          Assumption Overrides
        </p>
        <div className="space-y-3">
          {[
            ...
            <div key={item.label}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-text-muted text-[10px]">Baseline: {item.baseline}</span>
              ...
              <div className="mt-1.5 h-1 overflow-hidden rounded-full bg-white/[0.06]">
                <div
                  className="h-full rounded-full bg-[#2F8CD9]"
      ...
      <div className="flex items-center gap-3 rounded-xl bg-white/[0.04] px-4 py-3">
        <span className="text-text-secondary text-xs">Shading</span>
        <div className="relative flex-1">
          <div className="h-1.5 rounded-full bg-white/[0.06]">
            <div className="bg-warning h-full w-[90%] rounded-full" />
          </div>
          <div className="border-warning bg-surface-primary absolute top-1/2 left-[90%] h-3.5 w-3.5 -translate-x-1/2 -translate-y-1/2 rounded-full border-2" />
        </div>
        <span className="bg-warning/15 text-warning rounded-md px-2 py-0.5 text-xs font-semibold tabular-nums">
          90%
        </span>
      </div>
    </div>
...
function SimulatorPanel() {
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2 rounded-xl border border-[#ff4021]/20 bg-[#ff4021]/10 px-4 py-2.5">
        <svg
          className="h-4 w-4 text-[#ff4021]"
          viewBox="0 0 24 24"
          fill="none"
          stroke="currentColor"
          strokeWidth={2}
        ...
        <span className="text-xs font-bold tracking-wider text-[#ff4021] uppercase">
          Simulation Mode
        </span>
        <span className="ml-auto text-[10px] text-[#ff4021]/70">
          Changes do not affect live data
        </span>
      </div>
        ...
        <div className="flex items-center justify-between border-b border-white/[0.06] px-4 py-3">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="rounded bg-[#ff4021]/15 px-1.5 py-0.5 text-[9px] font-bold text-[#ff4021] uppercase">
                Sandbox
              </span>
            </div>
            <p className="text-text-muted mt-0.5 text-[10px]">4 herds · 186 head</p>
          </div>
        </div>
        ...
        <div className="border-b border-white/[0.04] px-4 py-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-text-muted text-[10px]">42 head · Grown Steer · 520 kg</p>
            </div>
            <p className="text-xs font-semibold text-white tabular-nums">{formatAUD(189_420)}</p>
          </div>
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            {[
              ...
              <div key={field.label} className="rounded-lg bg-white/[0.04] px-3 py-2">
                <p className="text-text-muted text-[9px]">{field.label}</p>
        ...
        <div className="border-b border-white/[0.04] px-4 py-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-text-muted text-[10px]">68 head · Breeder Cow · 480 kg</p>
            </div>
            <p className="text-xs font-semibold text-white tabular-nums">{formatAUD(272_680)}</p>
          </div>
        </div>
        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-text-muted text-[10px]">76 head · Weaner Steer · 220 kg</p>
            </div>
            <p className="text-xs font-semibold text-white tabular-nums">{formatAUD(112_480)}</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl bg-white/[0.04] p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-text-muted mt-0.5 text-[10px]">J. McAllister · Doongara Station</p>
          </div>
          <span className="rounded-md bg-[#1E5C8C]/20 px-2 py-0.5 text-[10px] font-medium text-[#2F8CD9]">
            Bank Copy
          </span>
        </div>
        <div className="text-text-muted mt-2 flex items-center gap-3 text-[10px]">
      ...
      <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
        <div className="rounded-xl bg-white/[0.04] p-3 text-center">
          <p className="text-text-muted text-[10px]">Producer Value</p>
          <p className="mt-1 text-sm font-bold text-white tabular-nums">$1,842,500</p>
        </div>
        <div className="rounded-xl bg-white/[0.04] p-3 text-center">
          <p className="text-text-muted text-[10px]">Advisor Adjusted</p>
          <p className="mt-1 text-sm font-bold text-[#2F8CD9] tabular-nums">$1,544,580</p>
        </div>
        <div className="rounded-xl bg-white/[0.04] p-3 text-center">
          <p className="text-text-muted text-[10px]">Variance</p>
          <p className="text-warning mt-1 text-sm font-bold tabular-nums">-16.2%</p>
        </div>
      </div>
          ...
          <table className="w-full text-[11px]">
            ...
            <tbody className="divide-y divide-white/[0.03]">
              {[
                ...
                {
                  assumption: "Breed Premium",
                  producer: "0%",
                  advisor: "-2.5%",
                  impact: "-$46,063",
                },
                {
                  assumption: "Daily Weight Gain",
                  producer: "1.0 kg",
                  advisor: "0.8 kg",
                  impact: "-$31,240",
                },
                ...
                <tr key={row.assumption} className="text-white/80">
                  ...
                  <td className="px-2 py-2 text-right text-[#2F8CD9] tabular-nums">
                    {row.advisor}
                  </td>
                  <td className="text-warning px-4 py-2 text-right font-semibold tabular-nums">
                    {row.impact}
                  </td>
                </tr>
              ))}
      ...
      <div className="rounded-xl bg-white/[0.04] p-4">
        ...
        <p className="text-text-secondary mt-2 text-xs leading-relaxed italic">
          &ldquo;Head count reduced from 186 to 178 to exclude 8 head pending vet clearance
          following recent drench resistance testing. Breed premium adjusted to -2.5% as the
          Doongara Angus herd carries a higher proportion of crossbreds than pure Angus, reducing
          the premium achievable at Charters Towers. DWG lowered to 0.8 kg/day reflecting
          below-average pasture conditions following a dry February and limited supplementary
          feeding. Calving rate reduced from 88% to 82% due to 24 first-calf heifers in the breeder
          herd, which historically calve at a lower rate. Mortality rate increased from 2.0% to 3.5%
          based on the property&#39;s 3-year rolling average, which accounts for tick fever losses
          in 2024. 10% shading applied per standard bank lending policy to provide a security margin
          on the assessed portfolio value.&rdquo;
        </p>
      </div>
    </div>
  );
...
const ADVISOR_FEATURES = [
  {
    title: "Dashboard",
    description:
      "Your advisory workspace at a glance. Track client connections, permission status, and regional portfolio distribution.",
    icon: (
      <svg
        className="h-5 w-5"
        viewBox="0 0 24 24"
  ...
  },
  {
    title: "Advisor Lens",
    description:
      "Apply private valuation overlays. Adjust breed premiums, weight gain, calving rates, and mortality. Add shading to stress-test portfolio values.",
    icon: (
      <svg
        className="h-5 w-5"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Clone client data into an isolated sandbox. Adjust head counts, weights, and growth rates to model scenarios without touching live valuations.",
    icon: (
      <svg
        className="h-5 w-5"
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    description:
      "Generate branded valuation summaries, asset registers, and accounting reports. Share via email or export as PDF.",
    icon: (
      <svg
        className="h-5 w-5"
        viewBox="0 0 24 24"
...
export default function ForAdvisors() {
  ...
  return (
    <section id="advisors" className="relative scroll-mt-[6.75rem]">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-sm font-medium tracking-wider uppercase" style={{ color: BLUE }}>
            For Advisors
          </span>
          ...
          <p className="text-text-secondary mx-auto mt-4 max-w-2xl text-base">
            Bankers, livestock agents, accountants, and insurers get dedicated tools to manage
            client portfolios with professional-grade analysis.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  <div
                    className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-lg transition-colors ${
                      isActive
                        ...
                        : "text-text-muted group-hover:text-text-secondary bg-white/[0.05]"
                    }`}
                  >
                    {feature.icon}
                  </div>
                  <div className="min-w-0">
                    <p
                      className={`text-sm font-semibold transition-colors ${isActive ? "text-white" : "text-text-secondary group-hover:text-white"}`}
                    >
                      {feature.title}
                    </p>
                    <p
                      className={`mt-0.5 text-xs leading-relaxed transition-colors ${isActive ? "text-text-secondary" : "text-text-muted"}`}
                    >
                      {feature.description}
                    </p>
                  </div>
