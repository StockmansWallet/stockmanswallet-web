...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.1-5.1a2.25 2.25 0 010-3.18l.38-.38a2.25 2.25 0 013.18 0l5.1 5.1m-7.08 7.08l5.1 5.1a2.25 2.25 0 003.18 0l.38-.38a2.25 2.25 0 000-3.18l-5.1-5.1m0 0l3.37-3.37m-3.37 3.37l-3.37 3.37M3.75 21h16.5" />
      </svg>
    ),
  },
  {
