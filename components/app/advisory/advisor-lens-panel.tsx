          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-advisor/15">
                {isActive ? <Eye className="h-5 w-5 text-advisor" /> : <EyeOff className="h-5 w-5 text-text-muted" />}
              </div>
              <div>
            ...
            <button
              ...
              className={`relative h-6 w-11 rounded-full transition-colors ${isActive ? "bg-advisor" : "bg-white/10"}`}
            >
